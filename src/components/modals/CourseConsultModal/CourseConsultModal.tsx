...
export const CourseConsultModal = ({id, title, price, setIsModal}: CourseConsultTypes) => {
    return (
    <div className="flex justify-center items-center fixed top-0 left-0 h-screen w-full bg-slate-900/80 text-white z-30">
        <div className="top-12 bg-violet-50/90 w-1/2 h-5/6 rounded-md backdrop-blur-sm flex flex-col items-center py-6 px-8 gap-4">
