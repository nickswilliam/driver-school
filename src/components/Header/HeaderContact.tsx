...
const HeaderContact = () => {
  return (
    <header className="bg-pink-500/90 flex flex-col items-center justify-center md:flex-row md:h-12 md:justify-end px-10 py-2 gap-4 h-40 w-full z-40 relative">
